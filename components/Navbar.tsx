    ...
    <div className="fixed top-4 left-0 right-0 z-[100] flex justify-center px-4 pointer-events-none">
      ...
      >
        ...
        >
          ...
          <span className="text-sm font-light tracking-tight text-gray-900 hidden sm:inline-block">Mostafa</span>
        </div>
        ...
        <div className="flex items-center gap-3">
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="bg-gray-900 text-white px-4 py-2 text-sm font-light hover:bg-gray-800 transition-all"
          >
            Contact Me
          </a>
          ...
          <div className="flex flex-col gap-1">
            {navLinks.map((link) => (
              <a
                ...
                href={`#${link.id}`}
                onClick={(e) => handleScrollTo(e, link.id)}
                className="text-gray-600 hover:text-gray-900 py-2.5 px-4 hover:bg-gray-50 transition-colors text-sm font-light"
              >
                {link.name}
              </a>
            ))}
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="bg-gray-900 text-white px-4 py-2.5 text-sm font-light hover:bg-gray-800 transition-all text-center mt-2"
            >
              Contact Me
            </a>
          </div>
